...
pessoa.apresentacao = function(){
    ...
    return console.log(`Olá, eu sou o ${pessoa.nomeCompleto}(), tenho ${pessoa.idade} anos, ${pessoa.altura}, meu peso é ${pessoa.peso} e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros} metros!`)
}
